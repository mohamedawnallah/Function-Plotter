...
def test_create_widgets(function_plotter: FunctionPlotter):
    ...
    assert function_plotter.plot_another_function_button is not None, "The add function button should not be None"
...
def test_connect_signals(function_plotter: FunctionPlotter):
    ...
    assert function_plotter.plot_another_function_button.clicked is not None, "The add function button should have a clicked signal"
